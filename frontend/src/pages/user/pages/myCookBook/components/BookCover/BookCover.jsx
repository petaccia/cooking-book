...
const BookCover = ({ user }) => {
  return (
    <div className="book-cover-container max-w-md mx-auto mb-8 perspective-1000">
      <div className="book-cover bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg shadow-2xl text-white overflow-hidden h-[650px] w-full relative transform rotate-y-5 transition-transform duration-300 hover:rotate-y-15">
